...
class Dfrpswc_Product_Update_Handler {
	...
	private function get_custom_attributes(): array {
		...
		// Get "_product_attributes" postmeta and ensure that it is in array format.
		$_product_attributes = array_filter( (array) maybe_unserialize(
			get_post_meta( $this->post['ID'], '_product_attributes', true ) )
		);

		/**
		 * This allows the user to add more custom attributes to the product.
		 *
		 * @param array $_product_attributes Current product's attributes.
		 ...
		 */
		$product_attributes = array_filter( (array) apply_filters(
		 ...
		 * )
		 */
//		error_log( '$product_attributes' . ': ' . print_r( $product_attributes, true ) );
